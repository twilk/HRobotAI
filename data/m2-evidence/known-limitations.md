...
- **H6** (limity godzin/nadgodziny): zgodność z etatem jako cel miękki optymalizacji; twarde limity — KM3.
- **Fairness**: metryka emitowana neutralnie; człon wariancji obciążeń — KM3.
...
- Izolacja tenantów (G6) potwierdzona testami jednostkowymi izolacji; test integracyjny na żywych bazach zaplanowany (CI-4, KM3).
