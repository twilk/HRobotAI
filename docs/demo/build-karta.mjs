...
const SEKCJE = [
  ...
  },
  {
    ...
    kroki: [
      ...
      ['Pokaż <b>Sygnały retencji</b>', 'Andrzej Kowalczyk — „dobry wynik, ale trend spadkowy”'],
      ['Pokaż <b>Mapę wydajności</b>', 'Anna 84 ↑ „Utrzymać” obok Rafał 66 ↓ −6,70 „Ryzyko”'],
    ...
    pointa: 'Raport pokazałby, że Rafał ma wynik 66. Ten moduł mówi: trend spadkowy, więc ryzyko odejścia — i sam proponuje rekrutację tam, gdzie z grafiku wynika luka.',
    pytania: [
      ...
      ['Czy AI może podjąć decyzję kadrową?',
       'Nie ma takiej ścieżki w kodzie. Ten moduł ma twardą granicę zapisu — analizuje i rekomenduje, nigdy nie wykonuje. Przycisk rejestruje decyzję człowieka.'],
    ],
    ostrzezenia: ['Pierwsze wejście liczy ~8 s — miej otwarte w drugiej karcie.'],
  },
  {
