...
const SEKCJE = [
  {
    ...
    pytania: [
      ...
      ['Dlaczego pokazujesz to na osobnym środowisku, a nie na naszym wdrożeniu?',
       'Bo na sali nie wolno mi wyświetlić danych osobowych Waszych pracowników — nazwisk, grafików ani ewidencji czasu pracy. To środowisko ma ten sam kod i te same moduły, tylko dane wygenerowane. Wdrożenie idzie swoim torem, niezależnie od tego pokazu.'],
      ['Czym to środowisko różni się od tego, na którym pracujemy?',
       'Kodem niczym — ten sam obraz i ta sama konfiguracja dziesięciu usług. Różnią się wyłącznie dane, a każdy najemca ma własną bazę: izolacja jest fizyczna, nie filtrem w zapytaniu, więc nic z tego pokazu nie ma jak dotknąć Waszego środowiska.'],
      ['Co z naszej wspólnej pracy wchodzi do rozliczenia KM3?',
       'Trzy moduły: Dokumenty z ewidencją i szkieletem ZUS, Analiza rozwoju z czterema wymiarami i trajektorią, oraz Agent Głosowy z dwunastoma poleceniami po polsku — sekcje 3.1, 3.2 i 3.3 raportu. Reszta prac wdrożeniowych jest poza wskaźnikiem odbioru i tak ją opisujemy.'],
    ],
  ...
  },
  {
    ...
    pytania: [
      ...
      ['Na którym poziomie autonomii to chodzi i czy zmiana wymaga wdrożenia?',
       'Poziomy są cztery: tylko sugestie, powiadomienie, pytanie o zgodę pracownika, zapis po zatwierdzeniu. To środowisko chodzi na trzecim. Zmiana poziomu to wpis w konfiguracji najemcy — nie nowa wersja systemu i nie przerwa w pracy.'],
    ],
